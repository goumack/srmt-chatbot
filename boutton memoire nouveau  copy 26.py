...
ℹ️ En mode RAG strict, je ne réponds qu'aux questions basées sur les documents juridiques.""",
            ...
            payload = {
                ...
                "options": {
                    ...
                    "top_p": 0.1,           # Remonter légèrement pour éviter de casser les réponses
                    "top_k": 1,             # Ne garde que le mot le plus probable à chaque étape
                    "repeat_penalty": 1.5,   # Réduit pour éviter de casser les réponses
                    "presence_penalty": 0.5, # Réduit aussi
                    "frequency_penalty": 0.3, # Réduit aussi
                    "num_ctx": 4096,        # Contexte limité pour se concentrer sur les documents fournis
                    "num_predict": 800,     # Augmenté pour permettre réponses complètes
                    "stop": [
                        "Code fictif", "Article 999", "n'existe pas vraiment",
                        "établissements d'hébergement touristique", "0% pour",
                        "peut être réduit jusqu'à"
                    ]  # Mots d'arrêt simplifiés - seulement les plus critiques
                }
            }
        ...
        try:
            ...
            for phrase in forbidden_phrases:
                if phrase in response_lower:
                    ...
                    return f"""⚠️ ERREUR D'INTERPRÉTATION DÉTECTÉE

La réponse générée contenait des informations non présentes dans les documents officiels.

📋 **INFORMATION OFFICIELLE CORRECTE** :
Selon l'Article 369 du Code des Impôts du Sénégal :
**"Le taux de la TVA est fixé à 18%"**

Il existe également un taux réduit spécifique :
**"Ce taux est réduit à 10% pour les prestations fournies par les établissements d'hébergement touristique agréés"**

✅ **POINT IMPORTANT** : Ces sont les SEULS taux mentionnés dans l'Article 369. Aucune autre réduction ou exception n'est spécifiée dans ce texte.

🔒 Réponse corrigée automatiquement pour éviter toute interprétation erronée."""

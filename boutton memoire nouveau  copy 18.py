...
- Si l'information DIRECTE n'est pas dans le texte, alors RÉSUME ce que contiennent les articles trouvés en expliquant leurs dispositions principales

STRUCTURE DE RÉPONSE SI INFORMATION DIRECTE ABSENTE:
"Bien que la procédure spécifique de [sujet] ne soit pas détaillée dans ces extraits, les articles trouvés traitent de :
- Article X : [résumé du contenu]
- Article Y : [résumé du contenu]

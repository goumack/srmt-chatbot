...
4. INTERDIT d'inventer, supposer, extrapoler ou modifier quelque valeur que ce soit
...
- Cite-la TEXTUELLEMENT avec références précises et valeurs EXACTES
- Si l'information DIRECTE n'est pas dans le texte, alors RÉSUME ce que contiennent les articles/sections trouvés en expliquant leurs dispositions principales AVEC LES VALEURS EXACTES
